...
const Customtabbar = ({state, descriptors, navigation, position}) => {
  ...
  console.log('MY CUSTOM STOP=============', customstopstate);
  const route = useRoute();
  console.log(route);
  //   console.log('ROUTE NAME', props.activeItemKey);
  useFocusEffect(
    React.useCallback(() => {
      checkScreen();
    }, []),
  ...
  console.log('NONE STATE===========', State.None);
  console.log('PAUSED STATE=========', State.Paused);
  console.log('PLAYING STATE=========', State.Playing);
  console.log('STOPPED STATE=========', State.Stopped);
